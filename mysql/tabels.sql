...
(NAME VARCHAR(40), DESCRIPTION VARCHAR(50), PRICE INT, MEASURE_UNIT VARCHAR(10), MAIN_INGREDIENT INT, CATEGORY VARCHAR(100))
BEGIN
	INSERT INTO PRODUCTS(NAME, DESCRIPTION, PRICE, MEASURE_UNIT, MAIN_INGREDIENT, CATEGORY)
	VALUES(NAME, DESCRIPTION, PRICE, MEASURE_UNIT, MAIN_INGREDIENT, CATEGORY);
	COMMIT;
END $$
